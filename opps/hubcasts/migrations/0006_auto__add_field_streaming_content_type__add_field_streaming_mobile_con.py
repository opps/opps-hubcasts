...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Streaming.content_type'
        db.add_column(u'hubcasts_streaming', 'content_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Streaming.mobile_content_type'
        db.add_column(u'hubcasts_streaming', 'mobile_content_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Streaming.content_type'
        db.delete_column(u'hubcasts_streaming', 'content_type')

        # Deleting field 'Streaming.mobile_content_type'
        db.delete_column(u'hubcasts_streaming', 'mobile_content_type')
    ...
    models = {
        ...
        u'hubcasts.streaming': {
            ...
            'mobile_content_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
