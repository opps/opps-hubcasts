...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Streaming.content'
        db.add_column(u'hubcasts_streaming', 'content',
                      self.gf('django.db.models.fields.CharField')(default='audio', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Streaming.content'
        db.delete_column(u'hubcasts_streaming', 'content')
