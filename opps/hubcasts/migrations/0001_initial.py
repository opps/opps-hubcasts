...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hubcasts_streaming', (
            ...
            ('port', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=8, null=True, blank=True)),
            ('sufix', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=25, null=True, blank=True)),
        ))
        db.send_create_signal(u'hubcasts', ['Streaming'])


    def backwards(self, orm):
        # Deleting model 'Streaming'
        db.delete_table(u'hubcasts_streaming')
    ...
    models = {
        ...
        u'hubcasts.streaming': {
            ...
            'sufix': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
